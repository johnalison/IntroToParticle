...
Look at 
\be
\braket{e_3 e_4|V|e_3 \gamma e_2} = \braket{e_4|V|\gamma e_2}
\ee
...
\bea
\braket{e_4|V|\gamma e_2} &=& \frac{e}{2}\int d^3x \braket{e_2 \gamma|\psi_e \phi_\gamma \psi_e|e_4}\\
...
\be
\braket{e_3\gamma|V|e_1} = e (2\pi)^3 \delta(p_4- p_2 - p_\gamma)
\ee

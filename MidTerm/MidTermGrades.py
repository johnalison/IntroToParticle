...
for i in range(len(grades_raw)):
    combined.append(round((grades_raw[i]/53*100 + home_work[i])/2,2))
print(combined)
...
plt.annotate("Mean = "+str(average), xy=(20, 2.5), xytext=(0,2.5),
             color="red", weight="light", fontsize=14,
             #arrowprops={"facecolor": "red"}
             )

plt.annotate("RMS ="+str(rms), xy=(20, 2.5), xytext=(0,2.2),
             color="red", weight="light", fontsize=14,
             #arrowprops={"facecolor": "red"}
             )

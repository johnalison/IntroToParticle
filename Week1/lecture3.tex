...
(This should all be familar to you.)

We will recap this in an adult way...
...
Start with the infitesimal case
\begin{equation*}
...
\begin{eqnarray*}
\textstyle
\Rightarrow a = d = 0  \hspace*{0.2in} \&   \hspace*{0.2in}  \underbrace{b=-c}_{\text{Can rescale $\epsilon$ such that b=1}}
\end{eqnarray*}
...
$R(\theta) = cos(\theta) + Isin(\theta) = {\begin{pmatrix} cos(\theta) &  sin(\theta)  \\ -sin(\theta)  & cos(\theta) \end{pmatrix}}$
...
Will now do 3D rotations... Something new happends.

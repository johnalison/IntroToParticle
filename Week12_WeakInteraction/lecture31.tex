...
\be
\mathcal{L} \subset \frac{1}{4} g^2 W_\mu^- W^{+\mu} (v+h)^2 = \underbrace{\frac{1}{4} g^2v^2 W_\mu^- W^{+\mu}}_{\rmt{W's Mass Term}}  + \underbrace{\frac{1}{2} g^2v W_\mu^- W^{+\mu}h}_{\includegraphics[width=0.25\textwidth]{./hWW.pdf}}  + \underbrace{\frac{1}{4} g^2 W_\mu^- W^{+\mu} hh}_{\includegraphics[width=0.25\textwidth]{./hhWW.pdf}}
\ee
...
eg: 
\be
\underbrace{\includegraphics[width=0.4\textwidth]{./ggF.pdf}}_{\rmt{\huge ``gluon fusion''}}
\hspace*{0.2in}
\underbrace{\includegraphics[width=0.4\textwidth]{./VBF.pdf}}_{\rmt{\huge ``Vector Boson Fusion''}}
\ee
